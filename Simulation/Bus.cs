...
namespace Simulation
{
    class Bus : Fahrzeug
    {
        public Bus(int pos_x, int pos_y, int speed, Color color, Form1 f, char pRichtung) : base(f)
        {
            position_x = pos_x; //Breite der PictureBox1 - Breite des Rechtecks (Position ist die obere linke Ecke)
            position_y = pos_y;
